...
type MockDockerRunner struct {
	...
	GetServicesInfoWithContextFunc    func(ctx context.Context, composePath string, serviceNames []string, projectName string, services map[string]config.Service, ws *interfaces.Workspace) (map[string]*interfaces.ServiceInfo, error)
	...
	NormalizeContainerNameFunc        func(workspace string, service string, project string, hasExplicitWorkspace bool) (string, error)
	NormalizeInfraNameFunc            func(workspace string, infra string, project string, hasExplicitWorkspace bool) (string, error)
...
func (m *MockDockerRunner) GetServicesStatusWithContext(ctx context.Context, composePath string) (map[string]string, error) {
...
func (m *MockDockerRunner) GetServicesInfoWithContext(ctx context.Context, composePath string, serviceNames []string, projectName string, services map[string]config.Service, ws *interfaces.Workspace) (map[string]*interfaces.ServiceInfo, error) {
...
func (m *MockDockerRunner) ViewLogsWithContext(ctx context.Context, composePath string, opts interfaces.LogsOptions) error {
