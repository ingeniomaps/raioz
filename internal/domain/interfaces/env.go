...
type EnvManager interface {
	...
	GenerateEnvFromTemplate(ws *Workspace, deps *models.Deps, serviceName string, servicePath string, svc models.Service, projectEnvPath string, projectDir string) error
	...
	ResolveEnvFiles(ws *Workspace, deps *models.Deps, serviceName string, envFiles []string, projectEnvPath string, includeProjectLevel bool, projectDir string) ([]string, error)
}
